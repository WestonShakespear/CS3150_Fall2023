...
//    - A main function that takes user input for 'n' and displays the nth Fibonacci number.
int fibonacciRecursive(int number)
{
    if (number <= 2)
    {
...
// Write a C program that uses recursion to compute the factorial of a number. The program should include:
